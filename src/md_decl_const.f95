...
!    real(kind=8), parameter :: molPAR_MJ = 2.30d0
    ...
    real(kind=8), parameter :: dmC= 0.48d0
    ...
    integer, dimension(12), parameter :: startDay = (/1, 32, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335/)
    integer, dimension(12), parameter :: endDay = (/31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334, 365/)
